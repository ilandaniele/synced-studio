  ...
  return (
    ...
    >
      ...
      <div className="px-2.5 md:px-5 pt-2.5">
        <div
          className={`
            w-full rounded-full px-[1.5vw] py-2 flex items-center justify-between
            border ${headerClass}
          `}
        >
...
function ItemRow({ title, value, helper, on = false }: ItemRowProps) {
  return (
    <div className="rounded-4xl border border-white/10 bg-white/[0.02] py-2 px-5 md:py-3 md:px-[1.8vw]">
      <div className="flex items-center justify-between">
        <div className="flex flex-col">
          <span className="uppercase tracking-[0.05em] text-white/90 text-[2vw] md:text-[0.8vw] font-semibold">
            {title}
          </span>
          <span
            className={`mt-0.5 flex items-center gap-1.5 text-[2vw] md:text-[0.8vw]
