    ...
    <>
            ...
            return (
              <div
                ...
                className={[
                  ...
                  'z-0 hover:z-50',
                  p.ratioClass,
                  hasImage ? 'bg-[#333] transition-transform duration-300'
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/90 backdrop-blur-md z-10" onClick={() => setOpen(false)} />

          <div className="relative max-w-7xl w-full px-4 z-20 mt-6 md:mt-12">
            {/* En mobile: el recuadro va en el flujo arriba de la imagen. En desktop: absoluto. */}
            <div
              className={`${
                isMobile
